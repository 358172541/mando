    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppStoreAuthors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTrackIssues", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppStoreBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppStoreBooks_AppStoreAuthors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AppStoreAuthors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppStoreAuthors_Name",
                table: "AppStoreAuthors",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_AppStoreBooks_AuthorId",
                table: "AppStoreBooks",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_AppStoreBooks_Name",
                table: "AppStoreBooks",
                column: "Name");
